        ...
        <h1 class="text-3xl font-bold mb-10">Input User</h1>
            <div class="mb-4">
                ...
                <input
                    ...
                    name="name" id="nama" type="text" value="{{ $dataUser->name }}" @readonly(true) @disabled(true)>
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="email">Email</label>
                <input
                    class="shadow border  text-gray-700 appearance-none rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
                    name="email" id="email" type="email" value="{{ $dataUser->email }}" @readonly(true) @disabled(true)>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow border  text-gray-700 appearance-none rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline"
                    role="role" id="nama" type="text" value="{{ $userRoles[0] }}" @readonly(true) @disabled(true)>
            </div>
    </div>
</div>
